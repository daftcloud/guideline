...
Nous avons entrepris, dans l'index ci-dessous, de répertorier les équivalences entre ces clés et les entrées dans nos guidelines.
 ...
 | :--------------- |:---------------| :-----|
 | ACO | Désignation de la collection ||| [Dans la description de l'œuvre](guideline/manifestationList.html#A-GCO_ref1) |
 | AFR | Désignation de la forme | [Dans la description du fichier](guideline/fileDesc.html#AFR_ref1) |||
 | AGN | Désignation du genre musical ||| [Dans la description de l'œuvre](guideline/manifestationList.html#AGN_ref1) |
 | AIN | Effectif ||| [Dans la description de l'œuvre](guideline/manifestationList.html#AIN_ref1) |
 ...
 | GAW | Œuvre associée ||| [Dans la description de l'œuvre](guideline/manifestationList.html#GAW_ref1) |
 | GCO | Désignation de la collection ||| [Dans la description de l'œuvre](guideline/manifestationList.html#A-GCO_ref1) |
 | GTL | Titre de la collection ||| [Dans la description de l'œuvre](guideline/manifestationList.html#GTL_ref1) |
 | LAR | Nom de l'arrangeur ||| [Dans la description de l'œuvre](guideline/manifestationList.html#LAR_ref1) |
 | LIB | Nom du librettiste ||| [Dans la description de l'œuvre](guideline/manifestationList.html#LIB_ref1) |
 | LOR | Nom de l'orchestrateur ||| [Dans la description de l'œuvre](guideline/manifestationList.html#LOR_ref1) |
 | MCN | Responsable de l'exécution ||| [Dans la description de l'œuvre](guideline/manifestationList.html#MCN_ref1) |
 | MGN | Groupe des interprètes ||| [Dans la description de l'œuvre](guideline/manifestationList.html#MGN_ref1) |
 | MLC | Lieu d'exécution ||| [Dans la description de l'œuvre](guideline/manifestationList.html#MLC_ref1) |
 | MPD | Date de la première exécution ||| [Dans la description de l'œuvre](guideline/manifestationList.html#MPN_ref1) |
 | MPN | Nom de l'interprète ||| [Dans la description de l'œuvre](guideline/manifestationList.html#MPN_ref1) |
 | MRD | Date d'exécution ||| [Dans la description de l'œuvre](guideline/manifestationList.html#MRD_ref1) |
 | MPS | Interprète soupçonné ||| [Dans la description de l'œuvre](guideline/manifestationList.html#MPS_ref1) |
 | OAC | Numéro d'acte ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OAC_ref1) |
 | OCO | Commanditaire ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OCO_ref1) |
 | OCL | Collecteur ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OCL_ref1) |
 | OCY | Pays de composition ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OCY_ref1) |
 | ODE | Dédicace ||| [Dans la description de l'œuvre](guideline/manifestationList.html#ODE_ref1) |
 | ODT | Date de composition ||| [Dans la description de l'œuvre](guideline/manifestationList.html#ODT_ref1) |
 | OMV | Numéro de mouvement ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OMV_ref1) |
 | OMD | Désignation du mouvement ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OMD_ref1) |
 | ONB | Nota bene ||| [Dans la description de l'œuvre](guideline/manifestationList.html#ONM_ref1) |
 | ONM | Numéro || [Dans la description de la source](guideline/sourceDesc.html#ONM_ref1) ||
 | OPR | Titre de l'œuvre d'appartenance ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OPR_ref1) |
 | OPC | Ville de composition ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OPC_ref1) |
 | OPS | Numéro d'opus ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OPS_ref1) |
 | OSC | Numéro de scène ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OSC_ref1) |
 | OTA | Titre alternatif ||| [Dans la description de l'œuvre](guideline/manifestationList.html#OTA_ref1) |
 | OTL | Titres | [Dans la description du fichier](guideline/fileDesc.html#OTL_ref1) |[Dans la description de la source](guideline/sourceDesc.html#PTL_ref1)|[Dans la description de l'œuvre](guideline/manifestationList.html#OTL_ref2), [Dans la description de l'œuvre](guideline/manifestationList.html#OTL_ref3)|
 ...
 | PPR | Premier éditeur || [Dans la description de la source](guideline/sourceDesc.html#PPR_ref1) | [Dans la description de l'œuvre](guideline/manifestationList.html#PPR_ref2)|
 ...
 | SCT | Catalogue scientifique || [Dans la description de la source](guideline/sourceDesc.html#SCA_ref1) ||
 | SMA | Accès au manuscrit || [Dans la description de la source](guideline/sourceDesc.html#SMA_ref1) ||
 | SML | Lieu de conservation || [Dans la description de la source](guideline/sourceDesc.html#SML_ref1) ||
 | SMS | Titre du manuscrit || [Dans la description de la source](guideline/sourceDesc.html#PTL_ref1) ||
 | TRN | Traducteur ||| [Dans la description de l'œuvre](guideline/manifestationList.html#TRN_ref1) |
 | TXL | Langue de la pièce ||| [Dans la description de l'œuvre](guideline/manifestationList.html#TXL_ref1) |
 | TXO | Langue originale ||| [Dans la description de l'œuvre](guideline/manifestationList.html#TXO_ref1) |
