...
Nous avons entrepris, dans l'index ci-dessous, de répertorier les équivalences entre ces clés et les entrées dans nos guidelines.
 ...
 | AGN | Désignation du genre musical ||| [Dans la description de l'œuvre](guideline/workList.html#AGN_ref1) |
 | AIN | Effectif ||| [Dans la description de l'œuvre](guideline/workList.html#AIN_ref1) |
 | AMD | Classification du mode (Moyen âge et Renaissance) ||| [Dans la description de l'œuvre](guideline/workList.html#AMD_ref1) |
 | AMT | Classification métrique ||| [Dans la description de l'œuvre](guideline/workList.html#AMT_ref1) |
 | AST | Désignation du style/période/typologie de l'œuvre ||| [Dans la description de l'œuvre](guideline/workList.html#AST_ref1) |
 ...
 | COM | Compositeur | [Dans la description du fichier](guideline/fileDesc.html#COM_ref1) |  [Dans la description de la source](guideline/sourceDesc.html#COM_ref3) | [Dans la description de l'œuvre](guideline/workList.html#COM_ref2) |
 ...
 | LAR | Nom de l'arrangeur ||| [Dans la description de l'œuvre](guideline/workList.html#LAR_ref1) |
 | LIB | Nom du librettiste ||| [Dans la description de l'œuvre](guideline/workList.html#LIB_ref1) |
 | LOR | Nom de l'orchestrateur ||| [Dans la description de l'œuvre](guideline/workList.html#LOR_ref1) |
 | MCN | Responsable de l'exécution ||| [Dans la description de l'œuvre](guideline/workList.html#MCN_ref1) |
 | MGN | Groupe des interprètes ||| [Dans la description de l'œuvre](guideline/workList.html#MGN_ref1) |
 | MLC | Lieu d'exécution ||| [Dans la description de l'œuvre](guideline/workList.html#MLC_ref1) |
 | MPD | Date de la première exécution ||| [Dans la description de l'œuvre](guideline/workList.html#MPN_ref1) |
 | MPN | Nom de l'interprète ||| [Dans la description de l'œuvre](guideline/workList.html#MPN_ref1) |
 | MRD | Date d'exécution ||| [Dans la description de l'œuvre](guideline/workList.html#MRD_ref1) |
 | MPS | Interprète soupçonné ||| [Dans la description de l'œuvre](guideline/workList.html#MPS_ref1) |
 | OAC | Numéro d'acte ||| [Dans la description de l'œuvre](guideline/workList.html#OAC_ref1) |
 | OCO | Commanditaire ||| [Dans la description de l'œuvre](guideline/workList.html#OCO_ref1) |
 | OCL | Collecteur ||| [Dans la description de l'œuvre](guideline/workList.html#OCL_ref1) |
 | OCY | Pays de composition ||| [Dans la description de l'œuvre](guideline/workList.html#OCY_ref1) |
 | ODE | Dédicace ||| [Dans la description de l'œuvre](guideline/workList.html#ODE_ref1) |
 | ODT | Date de composition ||| [Dans la description de l'œuvre](guideline/workList.html#ODT_ref1) |
 | OMV | Numéro de mouvement ||| [Dans la description de l'œuvre](guideline/workList.html#OMV_ref1) |
 | OMD | Désignation du mouvement ||| [Dans la description de l'œuvre](guideline/workList.html#OMD_ref1) |
 | ONB | Nota bene ||| [Dans la description de l'œuvre](guideline/workList.html#ONM_ref1) |
 | ONM | Numéro || [Dans la description de la source](guideline/sourceDesc.html#ONM_ref1) ||
 | OPR | Titre de l'œuvre d'appartenance ||| [Dans la description de l'œuvre](guideline/workList.html#OPR_ref1) |
 | OPC | Ville de composition ||| [Dans la description de l'œuvre](guideline/workList.html#OPC_ref1) |
 ...
 | OTL | Titres | [Dans la description du fichier](guideline/fileDesc.html#OTL_ref1) |||
 ...
 | PC# | Numéro de catalogue || [Dans la description de la source](guideline/sourceDesc.html#PC_ref1) ||
 ...
 | SCA | Catalogue scientifique || [Dans la description de la source](guideline/sourceDesc.html#SCA-T_ref1) ||
 | SCT | Catalogue scientifique || [Dans la description de la source](guideline/sourceDesc.html#SCA-T_ref1) ||
 ...
 | SMS | Titre du manuscrit || [Dans la description de la source](guideline/sourceDesc.html#SMS_ref1) ||
 | TRN | Traducteur ||| [Dans la description de l'œuvre](guideline/workList.html#TRN_ref1) |
 | TXL | Langue de la pièce ||| [Dans la description de l'œuvre](guideline/workList.html#TXL_ref1) |
